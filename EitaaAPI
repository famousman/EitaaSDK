<?php
if (file_exists('EitaaErrorLogger.php')) {
    require_once 'EitaaErrorLogger.php';
}
/**
 * Eitaa Bot Class.
 *
...
class Eitaa
{
    ...
    /// Class constructor
    /**
     * Create a Eitaa instance from the bot token
    ...
    /// A method for responding http to Eitaa.
    /**
     * \return the HTTP 200 to Eitaa.
     */
     ...
     * <td>String</td>
     * <td>Optional</td>
     * <td>Send <em>Markdown</em>, if you want Eitaa apps to show bold, italic and inline URLs in your bot's message. For the moment, only Eitaa for Android supports this.</td>
     * </tr>
     * <tr>
     ...
     * <tr>
     * <td>photo</td>
     * <td><a href="https://core.Eitaa.org/bots/api#inputfile">InputFile</a> or String</td>
     * <td>Yes</td>
     * <td>Photo to send. Pass a file_id as String to send a photo that exists on the Eitaa servers (recommended), pass an HTTP URL as a String for Eitaa to get a photo from the Internet, or upload a new photo using multipart/form-data.</td>
     * </tr>
     * <tr>
     * <td>caption</td>
     * <td>String</td>
    ...
    {
		$extensions=array("jpg","png","jpg");
		preg_match_all('/.*\.(\w{3,})$/mi', $content['file'], $matches, PREG_SET_ORDER, 0);
		if(!in_array($matches[0][1],$extensions))
			throw new Exception('it should be jpg or png');
        return $this->endpoint('sendPhoto', $content);
    }
    /// Send an audio
    /**
     * Use this method to send audio files, if you want Eitaa clients to display them in the music player. Your audio must be in the .mp3 format. On success, the sent Message is returned. Bots can currently send audio files of up to 50 MB in size, this limit may be changed in the future.
     ...
     * <td><a href="https://core.Eitaa.org/bots/api#inputfile">InputFile</a> or String</td>
     * <td>Yes</td>
     * <td>Audio file to send. Pass a file_id as String to send an audio file that exists on the Eitaa servers (recommended), pass an HTTP URL as a String for Eitaa to get an audio file from the Internet, or upload a new one using <strong>multipart/form-data</strong>.</td>
     * </tr>
     * <tr>
     * <td>duration</td>
     * <td>Integer</td>
    ...
    {
		$extensions=array("mp3","wav","wav");
		preg_match_all('/.*\.(\w{3,})$/mi', $content['file'], $matches, PREG_SET_ORDER, 0);
		if(!in_array($matches[0][1],$extensions))
			throw new Exception('it should be mp3 or wav');
     ...
     * <td>Yes</td>
     * <td>File to send. Pass a file_id as String to send a file that exists on the Eitaa servers (recommended), pass an HTTP URL as a String for Eitaa to get a file from the Internet, or upload a new one using <strong>multipart/form-data</strong>.</td>
     * </tr>
     * <tr>
     * <td>caption</td>
     * <td>String</td>
    ...
    public function sendFile(array $content)
    {
        return $this->endpoint('sendFile', $content);
    }
	/// Send a sticker
    /**
     ...
     * <td><a href="https://core.Eitaa.org/bots/api#inputfile">InputFile</a> or String</td>
     * <td>Yes</td>
     * <td>Sticker to send. You can either pass a <em>file_id</em> as String to resend a sticker that is already on the Eitaa servers, or upload a new sticker using <strong>multipart/form-data</strong>.</td>
     * </tr>
     * <tr>
     * <td>reply_to_message_id</td>
     * <td>Integer</td>
    ...
    public function sendSticker(array $content)
    {
		...
		preg_match_all('/.*\.(\w{3,})$/mi', $content['file'], $matches, PREG_SET_ORDER, 0);
		if(!in_array($matches[0][1],$extensions))
			throw new Exception('it should be webp. you can change the extension of png or jpg file to "webp"');
		unset($content["caption"]);
        return $this->endpoint('sendSticker', $content);
    }
    /// Send a video
    /**
     * Use this method to send video files, Eitaa clients support mp4 videos (other formats may be sent as Document). On success, the sent Message is returned. Bots can currently send video files of up to 50 MB in size, this limit may be changed in the future.<br/>Values inside $content:<br/>
     * <table>
     * <tr>
     * <td><strong>Parameters</strong></td>
     * <td><strong>Type</strong></td>
     ...
     * <td><a href="https://core.Eitaa.org/bots/api#inputfile">InputFile</a> or String</td>
     * <td>Yes</td>
     * <td>Video to send. Pass a file_id as String to send a video that exists on the Eitaa servers (recommended), pass an HTTP URL as a String for Eitaa to get a video from the Internet, or upload a new video using <strong>multipart/form-data</strong>.</td>
     * </tr>
     * <tr>
     * <td>duration</td>
     * <td>Integer</td>
    ...
    public function sendVideo(array $content)
    {
		...
		preg_match_all('/.*\.(\w{3,})$/mi', $content['file'], $matches, PREG_SET_ORDER, 0);
		if(!in_array($matches[0][1],$extensions))
			throw new Exception('it should be mp4 or 3gp');
    ...
    public function sendAnimation(array $content)
    {
		...
		preg_match_all('/.*\.(\w{3,})$/mi', $content['file'], $matches, PREG_SET_ORDER, 0);
		if(!in_array($matches[0][1],$extensions))
			throw new Exception('it should be gif. you can change the extension of mp4 file to "gif"');
		unset($content["caption"]);
        return $this->endpoint('sendAnimation', $content);
    }
    /// Send a voice message
    /**
     *  Use this method to send audio files, if you want Eitaa clients to display the file as a playable voice message. For this to work, your audio must be in an .ogg file encoded with OPUS (other formats may be sent as Audio or Document). On success, the sent Message is returned. Bots can currently send voice messages of up to 50 MB in size, this limit may be changed in the future.<br/>Values inside $content:<br/>
     * <table>
     * <tr>
     * <td><strong>Parameters</strong></td>
     * <td><strong>Type</strong></td>
     ...
     * <td><a href="https://core.Eitaa.org/bots/api#inputfile">InputFile</a> or String</td>
     * <td>Yes</td>
     * <td>Audio file to send. Pass a file_id as String to send a file that exists on the Eitaa servers (recommended), pass an HTTP URL as a String for Eitaa to get a file from the Internet, or upload a new one using <strong>multipart/form-data</strong>.</td>
     * </tr>
     * <tr>
     * <td>caption</td>
     * <td>String</td>
    ...
    {
		$extensions=array("ogg","wav","wav");
		preg_match_all('/.*\.(\w{3,})$/mi', $content['file'], $matches, PREG_SET_ORDER, 0);
		if(!in_array($matches[0][1],$extensions))
			throw new Exception('it should be ogg or wav');
     ...
     * <td>Integer</td>
     * <td>Optional</td>
     * <td>Period in seconds for which the location will be updated (see <a href="https://Eitaa.org/blog/live-locations">Live Locations</a>, should be between 60 and 86400.</td>
     * </tr>
     * <tr>
     * <td>disable_notification</td>
     * <td>Boolean</td>
    ...
    /// Send Venue
    /**
     * Use this method to send information about a venue. On success, the sent <a href="https://core.Eitaa.org/bots/api#message">Message</a> is returned.<br/>Values inside $content:<br/>
     * <table>
     * <tr>
     * <td><strong>Parameters</strong></td>
     * <td><strong>Type</strong></td>
     ...
     * <td>Boolean</td>
     * <td>Optional</td>
     * <td>Sends the message <a href="https://Eitaa.org/blog/channels-2-0#silent-messages">silently</a>. iOS users will not receive a notification, Android users will receive a notification with no sound.</td>
     * </tr>
     * <tr>
     * <td>reply_to_message_id</td>
     * <td>Integer</td>
     ...
     * <td>Optional</td>
     * <td>Additional interface options. A JSON-serialized object for an <a href="https://core.Eitaa.org/bots#inline-keyboards-and-on-the-fly-updating">inline keyboard</a>, <a href="https://core.Eitaa.org/bots#keyboards">custom reply keyboard</a>, instructions to hide reply keyboard or to force a reply from the user.</td>
     * </tr>
     * </table>
     * \param $content the request parameters as array
     * \return the JSON Eitaa's reply.
    ...
    //Send contact
    /**Use this method to send phone contacts. On success, the sent <a href="https://core.Eitaa.org/bots/api#message">Message</a> is returned.</p> <br/>Values inside $content:<br/>
     * <table>
     * <tr>
     * <td><strong>Parameters</strong></td>
     * <td><strong>Type</strong></td>
     ...
     * <td><a href="https://core.Eitaa.org/bots/api#inlinekeyboardmarkup">InlineKeyboardMarkup</a> or <a href="https://core.Eitaa.org/bots/api#replykeyboardmarkup">ReplyKeyboardMarkup</a> or <a href="https://core.Eitaa.org/bots/api#replykeyboardhide">ReplyKeyboardHide</a> or <a href="https://core.Eitaa.org/bots/api#forcereply">ForceReply</a></td>
     * <td>Optional</td>
     * <td>Additional interface options. A JSON-serialized object for an <a href="https://core.Eitaa.org/bots#inline-keyboards-and-on-the-fly-updating">inline keyboard</a>, <a href="https://core.Eitaa.org/bots#keyboards">custom reply keyboard</a>, instructions to hide keyboard or to force a reply from the user.</td>
     * </tr>
     * </table>
     * \param $content the request parameters as array
     * \return the JSON Eitaa's reply
    ...
    /// Send a chat action
    /**
     *  Use this method when you need to tell the user that something is happening on the bot's side. The status is set for 5 seconds or less (when a message arrives from your bot, Eitaa clients clear its typing status).
     *
    ...
    /**
     *  Use this method to get basic info about a file and prepare it for downloading. For the moment, bots can download files of up to 20MB in size. On success, a File object is returned. The file can then be downloaded via the link https://api.Eitaa.org/file/bot<token>/<file_path>, where <file_path> is taken from the response. It is guaranteed that the link will be valid for at least 1 hour. When the link expires, a new one can be requested by calling getFile again.
    ...
    /**
     * Use this method to get up to date information about the chat (current name of the user for one-on-one conversations, current username of a user, group or channel, etc.). Returns a <a href="https://core.Eitaa.org/bots/api#chat">Chat</a> object on success.<br/>Values inside $content:<br/>
     * <table>
     * <tr>
     * <td><strong>Parameters</strong></td>
     * <td><strong>Type</strong></td>
    ...
    /**
     * Use this method to get information about a member of a chat. Returns a <a href="https://core.Eitaa.org/bots/api#chatmember">ChatMember</a> object on success.<br/>Values inside $content:<br/>
     * <table>
     * <tr>
     * <td><strong>Parameters</strong></td>
     * <td><strong>Type</strong></td>
     ...
     * <tr>
     * <td>results</td>
     * <td>Array of <a href="https://core.Eitaa.org/bots/api#inlinequeryresult">InlineQueryResult</a></td>
     * <td>Yes</td>
     ...
     * <td>String</td>
     * <td>Optional</td>
     * <td>Send <a href="https://core.Eitaa.org/bots/api#markdown-style"><em>Markdown</em></a> or <a href="https://core.Eitaa.org/bots/api#html-style"><em>HTML</em></a>, if you want Eitaa apps to show <a href="https://core.Eitaa.org/bots/api#formatting-options">bold, italic, fixed-width text or inline URLs</a> in your bot&#39;s message.</td>
     * </tr>
     * <tr>
     * <td>disable_web_page_preview</td>
     * <td>Boolean</td>
     ...
     * <tr>
     * <td>reply_markup</td>
     * <td><a href="https://core.Eitaa.org/bots/api#inlinekeyboardmarkup">InlineKeyboardMarkup</a></td>
     * <td>Optional</td>
     * <td>A JSON-serialized object for an <a href="https://core.Eitaa.org/bots#inline-keyboards-and-on-the-fly-updating">inline keyboard</a>.</td>
     * </tr>
     * </table>
     * \param $content the request parameters as array
     * \return the JSON Eitaa's reply.
    ...
    /**
     *  Use this method to to download a file from the Eitaa servers.
     * \param $Eitaa_file_path String File path on Eitaa servers
     * \param $local_file_path String File path where save the file.
     */
    public function downloadFile($Eitaa_file_path, $local_file_path)
    {
        $file_url = 'https://api.Eitaa.org/file/bot'.$this->bot_token.'/'.$Eitaa_file_path;
     ...
     *
     * If you'd like to make sure that the Webhook request comes from Eitaa, we recommend using a secret path in the URL, e.g. https://www.example.com/<token>. Since nobody else knows your botâ€˜s token, you can be pretty sure itâ€™s us.
    ...
    /**
     *  Use this method to remove webhook integration if you decide to switch back to <a href="https://core.Eitaa.org/bots/api#getupdates">getUpdates</a>. Returns True on success. Requires no parameters.
     * \return the JSON Eitaa's reply.
     */
     ...
     * \param $pay  Boolean Optional. Specify True, to send a <a href="https://core.Eitaa.org/bots/api#payments">Pay button</a>.
    ...
    /** Upon receiving a message with this object, Eitaa clients will hide the current custom keyboard and display the default letter-keyboard. By default, custom keyboards are displayed until a new keyboard is sent by a bot. An exception is made for one-time keyboards that are hidden immediately after the user presses a button.
     * \param $selective Boolean Use this parameter if you want to show the keyboard to specific users only. Targets: 1) users that are @mentioned in the text of the Message object; 2) if the bot's message is a reply (has reply_to_message_id), sender of the original message.
    ...
    /* Upon receiving a message with this object, Eitaa clients will display a reply interface to the user (act as if the user has selected the bot‘s message and tapped ’Reply'). This can be extremely useful if you want to create user-friendly step-by-step interfaces without having to sacrifice privacy mode.
     * \param $selective Boolean Use this parameter if you want to show the keyboard to specific users only. Targets: 1) users that are @mentioned in the text of the Message object; 2) if the bot's message is a reply (has reply_to_message_id), sender of the original message.
    ...
    /// Send an invoice
    /**
     * Use this method to send invoices. On success, the sent <a href="https://core.Eitaa.org/bots/api#message">Message</a> is returned.
     * <table>
     * <tr>
     * <td><strong>Parameters</strong></td>
     * <td><strong>Type</strong></td>
     ...
     * <td>String</td>
     * <td>Yes</td>
     * <td>Three-letter ISO 4217 currency code, see <a href="https://core.Eitaa.org/bots/payments#supported-currencies">more on currencies</a></td>
     * </tr>
     * <tr>
     * <td>prices</td>
     * <td>Array of <a href="https://core.Eitaa.org/bots/api#labeledprice">LabeledPrice</a></td>
     * <td>Yes</td>
     ...
     * <td>Boolean</td>
     * <td>Optional</td>
     * <td>Sends the message <a href="https://Eitaa.org/blog/channels-2-0#silent-messages">silently</a>. Users will receive a notification with no sound.</td>
     * </tr>
     * <tr>
     * <td>reply_to_message_id</td>
     * <td>Integer</td>
     ...
     * <td><a href="https://core.Eitaa.org/bots/api#inlinekeyboardmarkup">InlineKeyboardMarkup</a></td>
     * <td>Optional</td>
     * <td>A JSON-serialized object for an <a href="https://core.Eitaa.org/bots#inline-keyboards-and-on-the-fly-updating">inline keyboard</a>. If empty, one 'Pay <code>total price</code>' button will be shown. If not empty, the first button must be a Pay button.</td>
     * </tr>
     * </table>
     * \param $content the request parameters as array
     * \return the JSON Eitaa's reply.
    ...
    public function sendInvoice(array $content)
    {
		if(!isset($content['CallbackURL']))
			$content['CallbackURL']='https://zarinpal.com';
		$client = new SoapClient('https://sandbox.zarinpal.com/pg/services/WebGate/wsdl', ['encoding' => 'UTF-8']);
				$result = $client->PaymentRequest(['MerchantID' => $content['MerchantID'],
...
$content['text']=' <a href=https://sandbox.zarinpal.com/pg/StartPay/'.$result->Authority.'>صورتحساب</a> ';
				} else {
    ...
    private function sendAPIRequest($url, array $content, $post = true)
    {
        ...
        curl_close($ch);
        if ($this->log_errors) {
            if (class_exists('EitaaErrorLogger')) {
                $loggerArray = ($this->getData() == null) ? [$content] : [$this->getData(), $content];
                EitaaErrorLogger::log(json_decode($result, true), $loggerArray);
            }
        }
        return $result;
    }
